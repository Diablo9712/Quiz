        ...
        ?>
           ...
           <div class="col-md-4 text-center col-sm-6 col-xs-6">
                    <div class="thumbnail product-box">
                      <a href="test.php?id=<?php echo $re['id_q'];?>">   <img src="img/quizz.jpg" style="width:160px; height:250px; border-radius:50%;">
                      </a>
                        <div class="caption" >
                            <h3 style="color:red"><a href="test.php?id=<?php echo $re['id_q'];?>" style="color:red"><?php echo $re['nomQuiz'];?></a></h3>



                            <p><a href="test.php?id=<?php echo $re['id_q'];?>" name="add_to_cart" pid="2" style="float:right;" id="product" class="btn btn-primary btn-xs">Passer</a>
</p>
                        </div>
                    </div>
                </div>
